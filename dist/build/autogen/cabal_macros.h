...
/* package CelAstnt-0.1.0.0 */
#define VERSION_CelAstnt "0.1.0.0"
#define MIN_VERSION_CelAstnt(major1,major2,minor) (\
  (major1) <  0 || \
  (major1) == 0 && (major2) <  1 || \
...
#define CURRENT_COMPONENT_ID "CelAstnt-0.1.0.0"

#define CURRENT_PACKAGE_KEY "CelAstnt-0.1.0.0"
